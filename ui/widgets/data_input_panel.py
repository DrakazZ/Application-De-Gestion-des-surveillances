...
class DataInputPanel(QFrame):
    ...
    def setup_ui(self):
        ...
        # Connections
        self.import_btn.clicked.connect(self.import_files, type=Qt.UniqueConnection)
        self.ga_config_btn.clicked.connect(self.open_ga_config, type=Qt.UniqueConnection)
    ...
    def _create_file_row(self, label_text, key):
        ...
        browse_btn.clicked.connect(
            lambda: self._browse_file(key, line_edit),
